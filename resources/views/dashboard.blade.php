...
<div class="bg-gray-900">
    <div class="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 class=" mx-auto max-w-2xl py-4 px-4 sm:py-24 sm:px-4 lg:max-w-7xl lg:px-4 text-2xl font-bold tracking-tight text-white">Products</h2>
      <div class="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
        ...
        <a href="#" class="group">
          ...
          <h3 class="mt-4 text-sm text-gray-400">Nescafe Stick</h3>
