      ...
      <div class="lg:flex items-stretch md:mt-12 mt-8">
        <div class="lg:w-1/2">
          <div class="sm:flex items-center justify-between xl:gap-x-8 gap-x-6">
            <div class="sm:w-1/2 relative">
              ...
              <img src="{{asset('images/img-5.jpg')}}" class="w-full" alt="chair" />
            </div>
            <div class="sm:w-1/2 sm:mt-0 mt-4 relative">
              ...
              <img src="{{asset('images/marina-zaharkina-oWBTvKB8Ro8-unsplash.jpg')}}" class="w-full" alt="wall design" />
            </div>
          </div>
          <div class="relative">
            <div>
            ...
            <img src="{{asset('images/ante-samarzija-lsmu0rUhUOk-unsplash.jpg')}}" alt="sitting place" class="w-full mt-8 md:mt-6 hidden sm:block" />
            <img class="w-full mt-4 sm:hidden" src="{{asset('images/Cup-Of-Creamy-Coffee-500x375.png')}}" alt="sitting place" />
          </div>
        </div>
        <div class="lg:w-1/2 xl:ml-8 lg:ml-4 lg:mt-0 md:mt-6 mt-4 lg:flex flex-col justify-between">
          <div class="relative">
            ...
            <img src="{{asset('images/Cup-Of-Creamy-Coffee-500x375.png')}}" alt="sitting place" class="w-full sm:block hidden" />
            <img class="w-full sm:hidden" src={{asset('images/ante-samarzija-lsmu0rUhUOk-unsplash.jpg')}}" alt="sitting place" />
          </div>
          <div class="sm:flex items-center justify-between xl:gap-x-8 gap-x-6 md:mt-6 mt-4">
            <div class="relative w-full">
              <div>
                <p class="p-6 text-xs font-medium leading-3 text-white absolute top-0 right-0">12 April 2021</p>
                <div class="absolute bottom-0 left-0 p-6">
                  <h2 class="text-xl font-semibold 5 text-white">The Decorated Coffee</h2>
                  <p class="text-base leading-4 text-white mt-2">Dive into minimalism</p>
                  <a href="javascript:void(0)" class="focus:outline-none focus:underline flex items-center mt-4 cursor-pointer text-white hover:text-gray-200 hover:underline">
                  </a>
                </div>
              </div>
              <img src="{{ asset('images/nathan-dumlao-71u2fOofI-U-unsplash.jpg')}}" class="w-full" alt="chair" />
            </div>
            <div class="relative w-full sm:mt-0 mt-4">
              <div>
                <p class="p-6 text-xs font-medium leading-3 text-white absolute top-0 right-0">12 April 2021</p>
                <div class="absolute bottom-0 left-0 p-6">
                  <h2 class="text-xl font-semibold 5 stroke-gray-900 stroke-2 text-white">The Sweetest Coffee</h2>
                  <p class="text-base leading-4 stroke-slate-100 text-white mt-2">Dive into minimalism</p>
                  <a href="javascript:void(0)" class="focus:outline-none focus:underline flex items-center mt-4 cursor-pointer text-white hover:text-gray-200 hover:underline">
                  </a>
                </div>
              </div>
              <img src="{{ asset('images/jeremy-yap-jn-HaGWe4yw-unsplash.jpg')}}" class="w-full" alt="" />
            </div>
          </div>
        </div>
      </div>
